#include "NetUDPClient_Linpack_Rustavi.h"

NetUDPClient_Linpack_Rustavi::NetUDPClient_Linpack_Rustavi(const QString& _ip, int _port,QObject *parent = 0)
    :NetUDPClient_Linpack(_ip,_port,parent)
{
    init();
    cout<<netDevice<<endl;
}

NetUDPClient_Linpack_Rustavi::~NetUDPClient_Linpack_Rustavi()
{
}

void NetUDPClient_Linpack_Rustavi::init()
{
    int i;
    //MODULES
...
void NetUDPClient_Linpack_Rustavi::send_CMD_SET(bool _is_emulation)
{
    if(!_is_emulation)
    {
